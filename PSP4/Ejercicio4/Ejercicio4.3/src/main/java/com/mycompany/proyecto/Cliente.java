    ...
    public static void main(String[] args) {
        try {
            ...
            if (exito) {
                ...
                while (!salir) {
                    ...
                    switch (comando) {
                        case "ls":
                            ...
                            break;
                        case "get":
                            System.out.println("Introduce la ruta del poema a mostrar");
                            String ruta = sn.next();
                            out.writeUTF(ruta);
                            ...
                            if (existe) {
                                ...
                                System.out.println("Errror, no existe el poema");
                            }
                            break;
                        case "exit":
                            salir = true;
                ...
                System.out.println("Uusario o contraseña incorrectos");
            }
